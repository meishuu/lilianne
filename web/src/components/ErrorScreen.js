...
export default class ErrorScreen extends React.Component {
  ...
  makeInner() {
    ...
    switch (type) {
      ...
      case 'not in server': return { // TODO
        ...
        body: (
          <div>
              ...
              <div className="member">
                ...
                <div className="member-inner">
                  <div className="member-username">
                    <span className="member-username-inner">
                      {data.user.username}
                    </span>
                  </div>
                  <span className="member-discriminator">
            ...
            <section>
              <p><strong>If this is the correct account</strong>, you're out of luck, buddy.</p>
              <p><strong>If this is the wrong account</strong>, <a href="https://discordapp.com/channels/@me">open Discord in your browser</a> and log into the correct account. Then click the button below.</p>
            </section>
          </div>
        ),
        footer: (
          <form method="POST" action="logout">
            <button className="primary" type="submit">Re-authenticate</button>
          </form>
        ),
      };
